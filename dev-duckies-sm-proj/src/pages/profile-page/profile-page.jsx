        ...
        <div className="upper-section card">
          ...
          >
            <div id="profile-pic-and-username" className="block">
              <figure
                className="image is-128x128 is-square mr-3 ml-3"
              ...
              <p>
                ...
                {userInfo.datetime_created
                  ? userInfo.datetime_created.substr(0, 10)
                  : "N/A"}
              </p>
            </div>
            <div id="edit-logic">
                ...
                <div id="text-area">
                  <form onSubmit={handleUserInfoSubmit}>
                    ...
                    <div id="text-area-save">
                      <button className="button mt-0" type="submit">
                        Save
                      </button>
                    </div>
                  </form>
                  ...
                  <div className="userInfo-and-button card-content">
                    ...
                    >
                      ...
                      {userInfo.date_of_birth
                        ? userInfo.date_of_birth.substr(0, 10)
                        : "N/A"}
                    </div>
                  </div>
                  <div className="userInfo-and-button card-content">
                    ...
                    >
                      Biography:{" "}
                      {userInfo.biography ? userInfo.biography : "N/A"}
                    </div>
                  </div>
                  <button
